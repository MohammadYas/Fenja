...
const REALISME =
  ...
  "two-year-old iPhone: framing is noticeably careless — the subject " +
...
const UNDGAA_FAELLES =
  ...
  // Ejer-ordre 23/8: ingen stramme bukser, kun iPhones — gælder også
  // alle prompts der skrives i fremtiden
  "skinny jeans, tight or skin-tight trousers, jeggings or leggings, denim " +
  "moulded to the thigh, low-rise trousers with a bare midriff above them, " +
  "Android or generic non-iPhone phones, " +
...
const SELFIE_KERNE =
  ...
  // Ejer-ordre 23/8: KUN iPhones. Står her i kernen, altså tidligt i
  // prompten hvor modellerne vægter det højest — de enkelte prompts
  // gentager det i deres egen telefon-beskrivelse.
  "The phone is ALWAYS an iPhone with its distinctive large square camera " +
  "module in the corner — never an Android phone, never a generic handset. ";
...
// P19: jeans-parrets EFTER som MAND (ejer-ordre 2026-08-20) — samme framing
// som P5 (bryst og ned, pasformen i fokus), men en mand i mellemblå jeans.
const EFTER_JEANS_MAND: KatalogPrompt = {
  id: "p19-efter-jeans-mand",
  titel: "P19 · EFTER — mand i mellemblå jeans (bryst og ned)",
  prompt: `Casual mirror photo for a secondhand clothing listing, framed from mid-chest down to the ankles — the jeans are the absolute focus, and the head is entirely OUTSIDE the top edge of the frame. A young adult man with an ordinary natural build photographs his jeans in a tall mirror in a bright bedroom corner. One hand holds a dark grey smartphone visible at the top of the frame; the other hand rests relaxed at his side. The jeans: a classic medium-blue vintage wash, straight-leg, mid-rise, visible waistband with a metal button, fly, belt loops and front pockets, no belt. Clearly matte denim twill texture, natural creases at hips and knees, slight stacking at the ankles, natural light whiskering — no artificial rips. The top is deliberately plain and secondary: a plain white t-shirt hanging loosely over the waistband, lifted slightly at one side so the waistband and button show. He stands slightly angled to the mirror, weight on one leg, so the fit reads naturally. Grey wool socks, no shoes. The legs fill most of the frame height; the camera points slightly down without distorting leg length. The room: white walls, pale wood floor, a chest of drawers and a laundry basket at the frame edge, daylight from one window, natural shadows along the legs, no flash.` +
    " Photo style: a completely authentic casual smartphone photo taken quickly for a secondhand clothing listing on Vinted — NOT a professional photoshoot, NOT editorial, NOT staged. Slightly careless framing with a small tilt, slightly uneven exposure, mild sensor noise, subtle JPEG artifacts, deep phone-camera focus with the background nearly as sharp as the garment, muted slightly dull natural colours, lived-in Scandinavian home with everyday mess at the frame edges. Vertical 2:3 composition." +
    " Avoid: AI look, CGI, render, a visible face or head, shoes, a model pose, extreme skinny fit, artificial rips, a belt, readable text or logos or labels, blurred background, bokeh, portrait mode, deformed hands or fingers, wrong mirror reflection, unnaturally long legs, plastic-smooth denim.",
};
